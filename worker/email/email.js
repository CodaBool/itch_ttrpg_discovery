...
<html>
  ...
  <body style="margin:0; min-height:100vh; display:grid; place-items:center; background:#0f172a; color:#e2e8f0; font-family:Arial,sans-serif;">
    <main style="display:flex; flex-direction:column; align-items:center; justify-content:center; gap:18px; width:100%; max-width:640px; padding:24px; box-sizing:border-box; text-align:center;">
      <h1 style="margin:0; font-size:32px; letter-spacing:0.08em; text-transform:uppercase; text-align: center;">Unsubscribed Successfully</h1>
